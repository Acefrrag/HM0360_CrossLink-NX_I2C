...
*******************************************************************************/
module PLL_sync_clk (clki_i, 
        clkop_o) ;
    input clki_i ; 
    output clkop_o ; 
    PLL_sync_clk_ipgen_lscc_pll #(.INTFBKDEL_SEL("DISABLED"),
...
// Module : lscc_pll
//==========================================================================
module PLL_sync_clk_ipgen_lscc_pll #(parameter FVCO = 800.0, 
    ...
    generate
        if ((APB_EN == 1)) 
            begin : APB2LMMI_INST
                ...
                ///
                PLL_sync_clk_ipgen_lscc_apb2lmmi #(.DATA_WIDTH(8),
                        .ADDR_WIDTH(7),
...
//==========================================================================
module PLL_sync_clk_ipgen_lscc_apb2lmmi #(parameter DATA_WIDTH = 32, 
